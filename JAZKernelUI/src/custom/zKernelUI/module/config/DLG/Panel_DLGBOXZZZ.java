...
public class Panel_DLGBOXZZZ extends KernelJPanelCascadedZZZ {
	protected KernelZZZ objKernelChoosen;
	private String sModule;

	//private Panel_CENTERZZZ panelCenter;
	
	
	public Panel_DLGBOXZZZ(KernelZZZ objKernel, JFrame frameParent, KernelZZZ objKernelChoosen, String sModule, String sProgram) throws ExceptionZZZ{
		...
		//try {
			...
			//### PANEL CENTER
			/* NICHT LÖSCHEN. FRAGE WARUM DAS SO IST ??? 
			//Laufleisten werden zwar hinzugefügt, funktionieren aber nicht  !!!!!
			...
			//+++ Den Scrollbaren Panel hinzufügen
			this.add(objPanelScroll, BorderLayout.CENTER);
			*/
			
		
			//!!! Wichtig ist es, dass das EAST-Panel VOR dem CENTER-PANEL eingefügt wird !!!
     		//### PANEL EAST
			...
			JScrollPane jsp = new JScrollPane(objPanelCenter);					
     		this.add(jsp, BorderLayout.CENTER);  			 //Mit Bildlaufleisten. ALSO: Über die JScrollPane wird das Panel_CENTERZZZ-Objekt eingebunden.
     		this.setPanelSub("CENTER", objPanelCenter); //Damit es von anderen Panels "greifbar" wird.
       		
     		
//     		TODO GOON die Inhalte der Textfelder des objPanelCenter für das objPanelEast abfragbar machen !!!
     		...
     		//TODO die Inhalte der Textfelder für Notes abfragbar machen.      	
     		//TODO das Schliessen der Dialogbox für Notes abfragbar machen
			...
			/*
			//Einfach mal 3 Felder, die dann auch per LotusScript ausgelesen werden können
			...
			*/
			...
			/*
			// nun ein Feld, für den ApplicationKey, dies auch per LotusScript auslesbar machen.
