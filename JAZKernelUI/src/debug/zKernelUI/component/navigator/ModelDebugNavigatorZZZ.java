...
public class ModelDebugNavigatorZZZ extends AbstractModelNavigatorZZZ{	
	...
	public ModelDebugNavigatorZZZ(IKernelZZZ objKernel, String sTitle, IPanelCascadedZZZ panelParent) throws ExceptionZZZ {
		super(objKernel, sTitle, panelParent);
	}
	
	public ModelDebugNavigatorZZZ(IKernelZZZ objKernel, String sTitle, IPanelCascadedZZZ panelParent, int iIndexInCollection) throws ExceptionZZZ {
