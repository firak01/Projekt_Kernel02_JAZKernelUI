...
public class FrameDebugNavigatorZZZ extends KernelJFrameCascadedZZZ{
...
public FrameDebugNavigatorZZZ(KernelZZZ objKernelConfig) throws ExceptionZZZ{
...
public KernelJPanelCascadedZZZ getPaneContent() throws ExceptionZZZ {
	PanelDebugNavigatorZZZ objPanel = new PanelDebugNavigatorZZZ(this.getKernelObject(), this);
