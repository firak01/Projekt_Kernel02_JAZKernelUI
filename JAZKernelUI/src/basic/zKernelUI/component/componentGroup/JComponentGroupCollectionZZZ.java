...
public class JComponentGroupCollectionZZZ<T>  extends AbstractKernelUseObjectZZZ<T>  implements Iterable<T>,IEventBrokerComponentGroupSwitchUserZZZ {
	...
	HashMapIndexedObjectZZZ<Integer,JComponentGroupZZZ> hmIndexed = null;
	...
	private boolean JComponentGroupCollectionNew_(IModelComponentGroupValueZZZ model, ArrayList<JComponentGroupZZZ>listaGroup) throws ExceptionZZZ{
		...
		main:{			
			...
			if(model!=null) {       ///Für eine GroupCollection MIT Modell
				HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>>hmComponent = model.createComponentHashMap();
	...
	public HashMapIndexedObjectZZZ<Integer,JComponentGroupZZZ>getHashMapIndexed() throws ExceptionZZZ{
		if(this.hmIndexed==null) {
			this.hmIndexed = new HashMapIndexedObjectZZZ<Integer,JComponentGroupZZZ>();
		}
		return this.hmIndexed;		
	}
	private void setHashMapIndexed(HashMapIndexedObjectZZZ<Integer,JComponentGroupZZZ> hmIndexed) {
	...
	public boolean add(JComponentGroupZZZ group) throws ExceptionZZZ{
		...
		main:{
			...
			HashMapIndexedObjectZZZ<Integer,JComponentGroupZZZ>hmIndexed = this.getHashMapIndexed();
			hmIndexed.put(group);
