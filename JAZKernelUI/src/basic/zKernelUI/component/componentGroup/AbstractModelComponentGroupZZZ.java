...
public abstract class AbstractModelComponentGroupZZZ extends AbstractKernelUseObjectZZZ  implements IModelComponentGroupValueZZZ{
	...
	protected HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>>hmComponent=null; //Die HashMap mit dem Index für die Gruppe und der ArrayList der Komponenten der Gruppe
	...
	public HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>> getComponentHashMap() throws ExceptionZZZ{
	...
	public ArrayList<JComponentGroupZZZ>createComponentGroupArrayList() throws ModelComponentGroupExceptionZZZ, ExceptionZZZ{
		...
		main:{
			HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>>hmComponent = this.getComponentHashMap();
	...
	public HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>>createComponentHashMap(String sTitle, IPanelCascadedZZZ panel) throws ExceptionZZZ {
		HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>> hmReturn = new HashMapIndexedObjectZZZ<Integer,ArrayList<JComponent>>();
		main:{
			int iIndexInCollection=0;
			HashMapIndexedObjectZZZ<Integer,ArrayList<String>> hmValuesText0 = this.createValuesText(sTitle, panel, iIndexInCollection);
			...
			while(bComponentsForIndexFilled) {
				iIndexInCollection++;
				HashMapIndexedObjectZZZ<Integer,ArrayList<String>> hmValuesText = this.createValuesText(sTitle, panel, iIndexInCollection);
...
//	}
	...
	public abstract HashMapIndexedObjectZZZ<Integer,ArrayList<String>>createValuesText(String sTitle, IPanelCascadedZZZ panel, int iIndexInCollection) throws ModelComponentGroupExceptionZZZ;			
