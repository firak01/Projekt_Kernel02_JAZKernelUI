...
public interface ITrayStatusMappedValueZZZ {
		//#######################################################
		...
		public EnumSet<?>getEnumSetUsed(){
			return TrayStatusTypeZZZ.getEnumSet();
		}
		...
		public static TrayStatusTypeZZZ fromAbbreviation(String s) {
		for (TrayStatusTypeZZZ state : values()) {
