...
public abstract class AbstractKernelActionListenerCascadedZZZ extends AbstractKernelUseObjectZZZ  implements IActionCascadedZZZ, IButtonEventZZZ, ActionListener{
	protected volatile IPanelCascadedZZZ panelParent;
	
	public AbstractKernelActionListenerCascadedZZZ(IKernelZZZ objKernel, IPanelCascadedZZZ panelParent) throws ExceptionZZZ{
		super(objKernel);
