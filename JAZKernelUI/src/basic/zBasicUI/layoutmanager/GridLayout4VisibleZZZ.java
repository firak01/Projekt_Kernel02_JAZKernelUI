 ...
 * 
 */
public class GridLayout4VisibleZZZ implements LayoutManager, java.io.Serializable
{
    int hgap;
    int vgap;
    int rows;
    ...
    public GridLayout4VisibleZZZ() {
    this(1, 0, 0, 0);
    }

    public GridLayout4VisibleZZZ(int rows, int cols) {
    this(rows, cols, 0, 0);
    }

    public GridLayout4VisibleZZZ(int rows, int cols, int hgap, int vgap) {
    if ((rows == 0) && (cols == 0)) {
